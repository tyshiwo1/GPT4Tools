...
class MagicBrush:
    def __init__(self, device):
        ...
        self.pipe = StableDiffusionInstructPix2PixPipeline.from_pretrained("./checkpoints/MagicBrush-epoch-52-step-4999.ckpt",
                                                                           safety_checker=None,
                                                                           torch_dtype=self.torch_dtype).to(device)
        self.pipe.scheduler = EulerAncestralDiscreteScheduler.from_config(self.pipe.scheduler.config)

    @prompts(name="Edit Image Using Text",
             description="useful when you want to change the objects according to the text. "
                         "like: alter the action of the objects in this image, or change the facial expression of the people in this image according to the text, or complete the objects in the image according to the text, or remove the objects in this image according to the text. "
